...
# @onready var tilemap: TileMapLayer = $CollisionTileMap
...
# 	TileMapHelper.setup_room_walls(tilemap, Vector2i(-25, -20), Vector2i(25, 20), 0, 0)
	
# 	# Example buildings/obstacles (adjust these to match where you want walls)
# 	# TileMapHelper.setup_collision_rectangle(tilemap, Vector2i(-10, -10), Vector2i(-5, -5), 0, 0)
# 	# TileMapHelper.setup_collision_rectangle(tilemap, Vector2i(5, -8), Vector2i(10, -3), 0, 0) 
...
# 	"""
# 	TileMapHelper.setup_collision_rectangle(tilemap, top_left, bottom_right, 0, 0)
...
# 	"""
# 	TileMapHelper.setup_room_walls(tilemap, top_left, bottom_right, 0, 0)
